...
install_termux(){
  ...
  cd beef
  apt update
  apt install -y ruby curl git nodejs python3 openssl readline libyaml libsqlite sqlite libxml2 autoconf ncurses automake libtool bison wget clang
}
...
finish() {
	...
	echo "#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#"
	echo
	info "Created By Ahmed AL-Nassif"
	info "Website: Cyber-Wise.blogspot.com"
	echo
	...
	cd ..
	mv beef ${HOME}
	info "Beef has been installed in: "${HOME}
}
...
main() {
	...
	echo "#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#"
	echo
  info "Created By Ahmed AL-Nassif with <3"
  info "Website: Cyber-Wise.blogspot.com"
	info "FB: fb.me/Ahm3d.Nassif"
  echo
